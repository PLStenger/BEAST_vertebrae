#!/bin/bash
#SBATCH --job-name=lunch_beast_curcubitaceae_fossils
#SBATCH --ntasks=1
#SBATCH -p long
...
#SBATCH --error="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_curcubitaceae_fossils.err"
#SBATCH --output="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_curcubitaceae_fossils.out"
...
./beast /home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/curcubitaceae_fossils.xml
