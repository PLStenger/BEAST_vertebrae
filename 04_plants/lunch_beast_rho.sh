#!/bin/bash
#SBATCH --job-name=lunch_beast_rho
#SBATCH --ntasks=1
#SBATCH -p long
...
#SBATCH --error="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_rho.err"
#SBATCH --output="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_rho.out"
...
./beast /home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/rho.xml
