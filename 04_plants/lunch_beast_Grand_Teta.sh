#!/bin/bash
#SBATCH --job-name=lunch_beast_Grand_Teta
#SBATCH --ntasks=1
#SBATCH -p long
...
#SBATCH --error="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_Grand_Teta.err"
#SBATCH --output="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_Grand_Teta.out"
...
./beast /home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/Grand_Teta.xml
