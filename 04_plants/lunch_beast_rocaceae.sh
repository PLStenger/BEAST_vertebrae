#!/bin/bash
#SBATCH --job-name=lunch_beast_rosaceae
#SBATCH --ntasks=1
#SBATCH -p gdec
...
#SBATCH --error="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_rosaceae.err"
#SBATCH --output="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_rosaceae.out"
...
./beast /home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/rosaceae.xml
