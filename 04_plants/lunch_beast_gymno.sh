#!/bin/bash
#SBATCH --job-name=lunch_beast_gymno
#SBATCH --ntasks=1
#SBATCH -p long
...
#SBATCH --error="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_gymno.err"
#SBATCH --output="/home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/lunch_beast_gymno.out"
...
./beast /home/plstenge/BEAST_vertebrae/BEAST_vertebrae/04_plants/gymno.xml
